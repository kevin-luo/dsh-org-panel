...
本项目当前使用 **PolyForm Noncommercial License 1.0.0**。

- ✅ 允许个人学习、研究、实验、非商业项目和其他许可证明确允许的非商业用途。
- ❌ **不允许商业使用**，包括将本项目或其修改版用于收费产品、SaaS、商业服务、商业交付、转售，或由商业组织用于生产经营等商业目的。
- 💼 如需商业使用，请先取得作者的单独书面商业授权，可通过 GitHub Issue 联系。
- 📜 此前已经明确以 MIT License 发布的历史版本继续保留当时仓库中的许可文本；本次变更不追溯修改历史版本的许可文件。

完整条款见 [`LICENSE`](./LICENSE)。本项目源码公开，但由于包含非商业限制，**不属于 OSI 定义下的开源软件许可**。
